                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-1 col-xs-12">
                        ...
                        <div class="form-group {{ $errors->has('category_type')? 'has-error':'' }}">
                            <label for="category_type" class="col-sm-4 control-label">@lang('app.category_type')</label>
                            <div class="col-sm-8">

                                <p><label> <input type="radio" name="category_type" value="general-classifieds" @if(!old('category_type') || old('category_type') == 'general-classifieds' ) checked="checked" @endif > @lang('app.general_classifieds') </label></p>
                                <p><label> <input type="radio" name="category_type" value="jobs"> @lang('app.jobs') </label></p>
                                <p><label> <input type="radio" name="category_type" value="cars_and_vehicles"> @lang('app.cars_and_vehicles') </label></p>
                                <p><label> <input type="radio" name="category_type" value="auction"> @lang('app.auction') </label></p>

                                {!! $errors->has('category_type')? '<p class="help-block">'.$errors->first('category_type').'</p>':'' !!}
                            </div>
                        </div>
