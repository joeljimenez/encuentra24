                                ...
                                @foreach($posts as $post)
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $button = '';
                                            $button .= '<a href="'.route('edit_page',$post->slug).'" class="btn btn-primary"><i class="fa fa-edit"></i> </a><a href="javascript:;" class="btn btn-danger deletePage" data-slug="'.$post->slug.'"><i class="fa fa-trash"></i> </a>';
                                            echo $button;
