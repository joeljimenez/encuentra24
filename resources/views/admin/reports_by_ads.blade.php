                ...
                @if( ! empty($title))
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h4 class="text-muted"><a href="{{  route('single_ad', $ad->slug) }}" target="_blank">{{ $ad->title }}</a></h4>
                            ...
                            <table class="table table-bordered table-striped table-responsive">
                                ...
                                @foreach($reports as $report)
                                    <tr>
                                        ...
                                        <td> <a href="{{ route('single_ad', $report->ad->slug) }}" target="_blank">@lang('app.view_ad')</a>
